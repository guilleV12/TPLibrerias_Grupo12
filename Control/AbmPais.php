...
class AbmPais{
    ...
    private function cargarObjeto($param){
        //print_r($param);
        $obj = null;
        if( array_key_exists('Nombre',$param) and array_key_exists('Poblacion',$param)
         and array_key_exists('Area',$param) and array_key_exists('Lenguaje',$param)){
            //echo "Crear Obj";
            $obj = new Pais();
            $obj->cargar($param['Nombre'], $param['Poblacion'],$param['Area'],$param['Lenguaje']);
        }
        return $obj;
    }
